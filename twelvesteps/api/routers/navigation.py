"""
NAVIGATION ROUTER — Зона навигации (Артём)

Все эндпоинты, которые вызывает Telegram-бот:
- Auth, User profile
- Steps (шаги, вопросы, черновики, переключение)
- Profile (разделы, ответы, свободный текст, история)
- SOS (помощь)
- Templates (шаблоны ответов, прогресс заполнения)
- Step10 (ежедневный самоанализ)
- Gratitudes (благодарности)
- Settings (настройки шагов)
- Legacy chat endpoints (chat, thanks, day)
"""
...
@router.post("/thanks", response_model=ChatResponse)
...
@router.post("/day", response_model=ChatResponse)
...
@router.post("/sos/chat", response_model=SosChatResponse)
...
@router.get("/steps/next", response_model=StepResponse)
...
@router.get("/steps/current", response_model=StepInfoResponse)
...
@router.get("/steps/{step_id}/detail")
...
@router.get("/steps/list", response_model=StepListResponse)
...
@router.get("/steps/{step_id}/questions", response_model=StepQuestionsResponse)
...
@router.get("/steps/draft", response_model=DraftResponse)
async def get_draft(
    current_context: CurrentUserContext = Depends(get_current_user)
):
...
@router.get("/steps/current/question-id")
...
@router.get("/steps/last-answered/question-id")
...
@router.get("/steps/question/{question_id}/previous", response_model=PreviousAnswerResponse)
...
@router.get("/steps/question/{question_id}/examples")
...
@router.post("/steps/switch-question", response_model=StepResponse)
...
@router.get("/steps/question/{question_id}")
...
@router.get("/steps/settings", response_model=StepsSettingsResponse)
...
@router.put("/steps/settings", response_model=StepsSettingsResponse)
...
@router.get("/profile/sections", response_model=ProfileSectionListResponse)
...
@router.get("/profile/sections/{section_id}", response_model=ProfileSectionDetailResponse)
...
@router.get("/profile/sections/{section_id}/answers")
...
@router.post("/profile/sections/{section_id}/answer")
...
@router.post("/profile/sections/{section_id}/free-text")
...
@router.get("/profile/free-text/history")
...
@router.get("/profile/sections/{section_id}/history")
...
@router.post("/profile/sections/{section_id}/data")
...
@router.put("/profile/section-data/{data_id}")
...
@router.delete("/profile/section-data/{data_id}")
...
@router.post("/profile/sections/custom")
...
@router.get("/profile/sections/{section_id}/summary", response_model=SectionSummaryResponse)
...
@router.put("/profile/sections/{section_id}")
...
@router.get("/steps/templates", response_model=AnswerTemplateListResponse)
...
@router.put("/steps/templates/{template_id}")
...
@router.post("/template-progress/start", response_model=TemplateProgressResponse)
...
@router.post("/template-progress/submit", response_model=TemplateFieldSubmitResponse)
...
@router.post("/template-progress/pause", response_model=TemplatePauseResponse)
...
@router.get("/template-progress/current", response_model=TemplateProgressResponse)
...
@router.get("/template-progress/fields-info", response_model=TemplateFieldsInfoResponse)
...
@router.delete("/template-progress/cancel")
...
# ===========================================================================
#  STEP 10 — Daily self-analysis
# ===========================================================================

@router.post("/step10/start", response_model=Step10StartResponse)
...
@router.post("/step10/submit", response_model=Step10SubmitAnswerResponse)
...
@router.post("/step10/pause", response_model=Step10PauseResponse)
...
@router.get("/step10/progress", response_model=Step10ProgressResponse)
...
@router.post("/gratitudes", response_model=GratitudeItem)
...
@router.get("/gratitudes", response_model=GratitudeListResponse)
