...
env_path = pathlib.Path(**file**).parent.parent.parent / “backend.env”
...
“”“Initialize profile sections and update step descriptions on startup”””
# 1. Profile sections
try:
...
```
# 2. Update step descriptions (only if short/missing)
try:
    ...
    STEP_DESCRIPTIONS = {
        1: ("Слово «первый» означает начало чего-то. Так и с шагами — Первый Шаг означает начало процесса выздоровления. "
            "С него начинается исцеление. Мы не сможем идти дальше, не работая по этому шагу. "
            "Некоторые из нас пришли в АН, потому что хотели прекратить употреблять. Но, приступая к Первому Шагу, "
            "мы обнаруживаем, что речь идёт о чём-то гораздо большем — о признании самой природы нашей болезни. "
            "Первый Шаг состоит из двух частей: признание бессилия перед наркоманией и признание того, "
            "что наша жизнь стала неуправляемой. Это не слабость — это честность. "
            "Именно капитуляция перед фактом болезни открывает дверь к выздоровлению. "
            "Без этого шага все остальные теряют смысл. Мы не можем решить проблему, которую не признаём. "
            "Первый Шаг — это фундамент. На нём строится всё остальное."),
        2: ("«Мы пришли к убеждению, что Сила, более могущественная, чем мы сами, может вернуть нас к здравомыслию». "
            "Первый Шаг лишает нас иллюзии относительно зависимости — Второй даёт надежду на выздоровление. "
            "Он говорит нам: то, что мы узнали о своей зависимости, ещё не конец истории. "
            "Нам не обязательно жить с болью и безумием, с которыми мы жили до сих пор. "
            "По мере приближения ко Второму Шагу мы начинаем думать, что, может быть, существует Сила, "
            "более могущественная, чем мы сами — Сила, способная исцелить нашу боль и вернуть нас к здравомыслию. "
            "Этот шаг не требует религиозности. В АН нет ничего, обязывающего быть религиозным. "
            "Это духовная, а не религиозная программа. "
            "Группа АН, духовные принципы шагов, любое личное понимание Высшей Силы — всё это может быть "
            "Силой, более могущественной, чем мы сами. "
            "Неважно, как далеко зашло наше безумие — ничто не может ограничить способность этой Силы вернуть нас к здравомыслию."),
        3: ("«Мы приняли решение препоручить нашу волю и наши жизни заботе Бога, как каждый из нас понимал его». "
            "Проработав первые два шага, мы капитулировали и обрели надежду. "
            "Третий Шаг — это действие: принятие решения. "
            "Само слово «решение» может пугать, особенно с учётом того, на что именно мы решаемся. "
            "Многие из нас давно не принимали никаких решений самостоятельно — за нас решала зависимость. "
            "Третий Шаг не означает, что мы должны внезапно полностью измениться. "
            "Фундаментальные изменения происходят постепенно, по мере работы по всем шагам. "
            "Это лишь решение — попробовать жить иначе, доверившись чему-то большему, чем мы сами. "
            "Каждый день мы можем возобновлять это решение. Это не разовый акт, а ежедневная практика."),
        4: ("«Мы провели глубокую и бесстрашную нравственную инвентаризацию самих себя». "
            "Многие из нас пришли в АН, чтобы прекратить употреблять. "
            "Но Четвёртый Шаг открывает нам, что употребление было лишь симптомом. "
            "Настоящая работа — это честный взгляд на себя: на обиды, страхи, причинённый ущерб, "
            "дефекты характера, которые управляли нашей жизнью. "
            "Инвентаризация — это не самобичевание. Это инструмент. "
            "Как владелец магазина делает опись товаров — что есть, чего не хватает, что залежалось — "
            "так и мы делаем опись своей внутренней жизни. "
            "Бесстрашие здесь означает готовность смотреть честно, не уклоняясь. "
            "Результат Четвёртого Шага — письменный документ, который станет основой для Пятого Шага."),
        5: ("«Мы признались Богу, самим себе и другому человеку в истинной сущности наших ошибок». "
            "Пятый Шаг — это не просто прочтение Четвёртого вслух. "
            "Это акт глубокой честности с тремя сторонами: с Богом нашего понимания, с собой и с другим человеком. "
            "Многие из нас несли груз секретов годами. Тайное всегда давит тяжелее, чем явное. "
            "Пятый Шаг освобождает нас от этого груза. "
            "Когда мы слышим собственные слова вслух в присутствии другого человека, "
            "мы перестаём быть пленниками своих тайн. "
            "Это требует смирения и доверия. Но именно здесь начинается настоящее исцеление — "
            "через принятие себя таким, какой ты есть, со всем тем, что было."),
        6: ("«Мы полностью подготовились к тому, чтобы Бог избавил нас от всех этих дефектов характера». "
            "Приступая к Шестому Шагу, мы уже видели свои дефекты характера в Четвёртом и Пятом Шагах. "
            "Теперь задача — обрести готовность расстаться с ними. "
            "Это звучит просто, но на практике многие дефекты кажутся нам необходимыми для выживания. "
            "Мы боимся, что без них потеряем себя. "
            "Шестой Шаг не требует, чтобы дефекты исчезли немедленно. "
            "Он требует лишь готовности — внутреннего согласия на изменения. "
            "Полная готовность означает: мы осознаём дефекты, устали от них, "
            "и верим, что Высшая Сила может нас от них освободить. "
            "Это длительный процесс, который часто растягивается на всю жизнь выздоровления."),
        7: ("«Мы смиренно просили Его избавить нас от наших недостатков». "
            "Седьмой Шаг тесно связан с Шестым. Если в Шестом мы обрели готовность, "
            "то в Седьмом — просим об изменениях. "
            "Ключевое слово — «смиренно». Не требуем, не торгуемся, не ставим условий. "
            "Смирение — это реалистичный взгляд на себя: не хуже и не лучше других, "
            "просто человек с болезнью, который просит о помощи. "
            "В этом шаге наша часть работы — не пассивное ожидание. "
            "Мы продолжаем жить, замечаем когда действуем из дефектов, "
            "и каждый раз возвращаемся к просьбе о помощи. "
            "Изменения приходят постепенно — через практику духовных принципов вместо старых паттернов."),
        8: ("«Мы составили список всех людей, которым мы навредили, и обрели готовность возместить им всем ущерб». "
            "До этого момента работа по шагам была направлена в основном на исцеление нас самих. "
            "Восьмой Шаг разворачивает нас лицом к другим людям. "
            "Суть шага — честно определить, кому мы причинили вред. "
            "Не важно, что именно послужило причиной: гнев, безразличие, страх, эгоизм. "
            "Не важно, намеренно мы навредили или случайно. "
            "Весь причинённый нами ущерб — это материал для Восьмого Шага. "
            "Список составляется письменно. Готовность возместить ущерб — это внутренняя работа, "
            "которую мы делаем прежде чем перейти к реальным действиям Девятого Шага."),
        9: ("«Мы напрямую возмещали причинённый этим людям ущерб, где это было возможно, "
            "кроме тех случаев, когда это могло повредить им или кому-либо ещё». "
            "Девятый Шаг — это действие. Мы встречаемся с людьми из нашего списка и возмещаем ущерб. "
            "Без духовной подготовки предыдущих шагов это было бы невозможно. "
            "Возмещение ущерба — это не просто извинение. "
            "Это разрешение проблемы, восстановление отношений и возвращение того, что мы взяли. "
            "Некоторые возмещения происходят быстро, другие растягиваются на годы. "
            "Главный критерий — не навредить ещё больше: ни тому человеку, ни себе, ни третьим лицам. "
            "Спонсор помогает решить, как и когда подходить к каждому пункту списка. "
            "Результат Девятого Шага — свобода от стыда и чувства вины, которые мы несли годами."),
        10: ("«Мы продолжали делать личную инвентаризацию и, когда мы были неправы, сразу признавали это». "
             "Десятый Шаг — это ежедневная практика честности и самонаблюдения. "
             "Первые девять шагов заложили фундамент. Теперь задача — удержать то, что мы обрели, и продолжать расти. "
             "Слово «продолжали» принципиально: это не разовое действие, а ежедневная практика. "
             "Каждый день мы наблюдаем за собой — замечаем гнев, страх, эгоизм, нечестность — "
             "и сразу берём ответственность, не откладывая. "
             "Десятый Шаг защищает нас от накопления обид и соскальзывания в старые паттерны. "
             "Мы учимся замечать ошибки быстро и исправлять их с достоинством — "
             "без самобичевания, но и без уклонения. "
             "Ежедневная инвентаризация — не наказание. Это инструмент свободы."),
        11: ("«Мы стремились путём молитвы и размышления углубить осознанный контакт с Богом, как мы Его понимали, "
             "молясь лишь о знании Его воли, которую нам надлежит исполнить, и о силе для этого». "
             "Одиннадцатый Шаг — это духовная практика: молитва, медитация и живой контакт с Богом нашего понимания. "
             "Этот шаг не про религию — про осознанность и духовную связь. "
             "Суть шага — не просить о том, чего мы хотим, а искать знания воли Бога нашего понимания "
             "и силы её исполнить. "
             "Молитва — это наш разговор с Высшей Силой. Медитация — умение замолчать и слушать. "
             "Шаг требует не совершенства, а лишь готовности. "
             "Со временем духовная практика становится основой жизни — "
             "она удерживает нас в равновесии даже в самые трудные дни."),
        12: ("«Пережив духовное пробуждение в результате работы по этим шагам, мы старались передать это послание "
             "другим наркоманам и применять эти принципы во всех наших делах». "
             "Двенадцатый Шаг — это шаг служения и жизни по принципам программы. "
             "Пережив духовное пробуждение, мы обнаруживаем: отдавая — получаем. "
             "Помогая другим — сами остаёмся чистыми. "
             "Служение принимает разные формы: быть спонсором, встречать новичков, "
             "помогать в организации собраний, просто быть рядом. "
             "Но самое важное — применять принципы программы во всех сферах жизни: "
             "в семье, на работе, в отношениях, в одиночестве. "
             "Духовное пробуждение — это не событие, которое случилось однажды. Это то, как мы живём."),
    }

    async with async_session_factory() as session:
        async with session.begin():
            updated = 0
            for step_index, description in STEP_DESCRIPTIONS.items():
                result = await session.execute(
                    sa_select(Step).where(Step.index == step_index)
                )
                step = result.scalar_one_or_none()
                if step and (not step.description or len(step.description) < 500):
                    step.description = description
                    updated += 1
            print(f"✅ Step descriptions updated: {updated}/12")
except Exception as e:
    print(f"⚠️ Warning: Could not update step descriptions: {e}")
    import traceback
    traceback.print_exc()
```
